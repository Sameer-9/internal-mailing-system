...
<a class="cursor-pointer" href="#">
	...
	>
		...
		<div>
			<div class="sender-name w-24 md:w-40 sm:w-32 sm:whitespace-normal md:whitespace-nowrap min-w-[70px] text-sm">
				{sender}
			</div>
		</div>
		...
		<div class:text-zinc-500={!isChecked} class="ml-auto pr-4 font-bold text-xs whitespace-nowrap time">
			{date}
		</div>
	</div>
</a>
