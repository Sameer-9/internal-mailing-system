	...
	>
		<div class="bg-[#FFFFFF] md:rounded-l-lg md:w-2/4 max-sm:w-full h-[90%]">
			<div class="pt-16 w-3/4 m-auto">
				<h1 class="text-3xl text-gray-800 font-semibold font-sans text-center">Register</h1>
				<div class="pt-3">
					<form action="?/register" method="post" use:enhance>
						...
						<div class="relative inline-block w-full max-w-xs">
							<input
								...
								name="password"
								placeholder={showConfirmPassword ? 'Enter Password' : '••••••••••'}
							/>
					...
					<p class="text-center text-sm pt-5">
						Already have an account? <a class="text-purple-500 font-bold" href="/login">Login</a>
					</p>
				</div>
			</div>
		</div>
